...
def main(argv: list[str]) -> None:
    ...
    if not all([project_id, location, bucket]):
        logging.error(
            ...
            "GOOGLE_CLOUD_PROJECT_ID, GOOGLE_CLOUD_LOCATION_REGION, and "
            "GOOGLE_CLOUD_STORAGE_BUCKET environment variables (in your .env "
            "file) or pass them as flags (--project_id, --location, --bucket)."
        )
        return
