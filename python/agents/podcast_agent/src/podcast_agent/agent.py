...
from .sub_agents.podcast_audio_generator.agent import podcast_audio_generator_agent

podcast_agent = SequentialAgent(
    name="podcast_agent",
    ...
    sub_agents=[
        ...
        podcast_transcript_writer_agent,
        podcast_audio_generator_agent,
    ],
)

root_agent = podcast_agent
