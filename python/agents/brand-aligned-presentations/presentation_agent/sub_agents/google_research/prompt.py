...
GOOGLE_RESEARCH_INSTRUCTION = """
    ...
    **CRITICAL CITATION MANDATE (RAW URLs ONLY):**
    ...
    3. **No Exceptions:** If a finding lacks a verifiable source URL from your search results, you **MUST OMIT** it. NEVER MAKE UP URLS SUCH AS [https://example.com] OR USE PLACEHOLDERS. NEVER CITE A SOURCE YOU DID NOT FIND IN YOUR SEARCH RESULTS.
