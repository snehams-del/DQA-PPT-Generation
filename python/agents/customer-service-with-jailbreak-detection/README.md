# Cymbal Home & Garden Customer Service Agent + Jailbreak Detection
...
In addition to the core functionality of the customer service agent, this variant also employs a jailbreak detection component, which is implimented via callback, as well as via sub-agent tool call.
...
- **Jailbreak Detection:**
  - Classifies a user input as malicious or benign and instructs the primary agent accordingly.
...
**Agent**:
This request has been flagged by our system. We cannot respond at this time.
...
