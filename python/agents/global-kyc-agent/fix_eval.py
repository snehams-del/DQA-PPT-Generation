...
with open('/Users/sgardezi/work/projects/kyc-agent-adk/eval/global_kyc.test.json', 'r') as f:
    eval_set = json.load(f)

# Subset of static tool calls for UK
uk_expected = [
    {"name": "transfer_to_agent", "args": {"agent_name": "uk_kyc_agent"}},
    {"name": "transfer_to_agent", "args": {"agent_name": "uk_report_generation_agent"}},
    ...
    {"name": "get_company_establishments", "args": {"company_number": "00445790"}},
...
usa_expected = [
    ...
    {"name": "transfer_to_agent", "args": {"agent_name": "usa_sequential_agent"}},
...
with open('/Users/sgardezi/work/projects/kyc-agent-adk/eval/global_kyc.test.json', 'w') as f:
