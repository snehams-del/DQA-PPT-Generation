...
def test_latex_to_text():
    ...
    assert latex_to_text(text) == "The formula is Hello × ≈ ≤ ≥ "
...
@patch('presentation_agent.sub_agents.deep_research.tools.deep_research_tool.genai.Client')
...
@pytest.mark.asyncio
@patch('presentation_agent.sub_agents.deep_research.tools.deep_research_tool._deep_research_sync_impl')
