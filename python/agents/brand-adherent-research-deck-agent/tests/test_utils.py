...
def test_apply_font():
    ...
    # Trigger exception
    with patch("presentation_agent.shared_libraries.utils.Pt", side_effect=Exception("Test Error")):
        _apply_font(run, "Arial", 12.0, (255, 0, 0))
...
def test_insert_image(mock_open, mock_exists, mock_image_open, mock_get_gcs_client):
    prs = MagicMock()
    ...
    mock_open.return_value.__enter__.return_value.read.return_value = b"local_bytes"
