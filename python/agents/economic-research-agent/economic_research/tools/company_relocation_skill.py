...
class CompanyRelocationRequest(BaseModel):
    ...
    industry: str | None = Field(None, description="Optional industry sector or NAICS name.")


def generate_company_relocation_report(city_names: list[str], industry: str | None = None) -> str:
    """
