...
MODEL_COORDINATOR = os.environ.get("NEXSHIFT_MODEL_COORDINATOR", "gemini-3.0-flash")
MODEL_CONTEXT_GATHERER = os.environ.get("NEXSHIFT_MODEL_CONTEXT_GATHERER", "gemini-3.0-flash")
