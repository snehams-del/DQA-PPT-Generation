...
@click.option(
    "--display-name",
    default="cyber-guardian-deploy",
    help="Display name for the agent engine",
)
@click.option(
    "--description",
    default="AI-driven agent for cybersecurity incident response",
    help="Description of the agent",
)
@click.option(
    "--source-packages",
    multiple=True,
    default=["./cyber_guardian"],
    help="Source packages to deploy. Can be specified multiple times (e.g., --source-packages=./app --source-packages=./lib)",
)
@click.option(
    "--entrypoint-module",
    default="cyber_guardian.agent_engine_app",
...
@click.option(
    "--requirements-file",
    default="cyber_guardian/app_utils/.requirements.txt",
...
def deploy_agent_engine_app(
    ...
    if not project:
        raise ValueError(
            "Google Cloud Project must be specified or available via default credentials"
        )
