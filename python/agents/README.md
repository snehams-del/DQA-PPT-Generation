...
| [Retail Skills Recipe](retail-skills-recipe) | Production-ready AI agent skills for retail: semantic product search (Vector Search, RAG, voice), virtual try-on (VTO + Gemini image), product recommendations, and content generation. Includes eval framework and self-improving skill optimizer. | Vector Search, RAG, Virtual try-on, Image generation, Recommendations, Content generation, Eval | Conversational | Intermediate | Single Agent | Retail |
