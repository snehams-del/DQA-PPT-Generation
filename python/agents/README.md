...
| [Frosty](frosty) | Self-hosted multi-agent Snowflake assistant that turns plain English into Snowflake operations using a large specialist-agent hierarchy. | Snowflake, Multi-agent, Skills, Data engineering, Governance, Security, Inspection | Conversational | Advanced | Multi Agent | Data & Analytics |
