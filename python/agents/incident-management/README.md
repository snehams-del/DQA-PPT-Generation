...
The assets and additional prerequisite instructions are available in the Application Integration Samples repo here: [Incident Management](https://github.com/GoogleCloudPlatform/application-integration-samples/tree/main/adk-incident-management).
