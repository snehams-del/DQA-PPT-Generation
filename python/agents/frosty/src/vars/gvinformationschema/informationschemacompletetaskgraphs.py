...
class CompleteTaskGraphsColumnList:
    _fn=InformationSchema._complete_task_graphs_fn
...
class InformationSchemaCompleteTaskGraphs:
    def __init__(self):
        self.columns=CompleteTaskGraphsColumnList()
