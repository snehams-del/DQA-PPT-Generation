...
logger.debug("[REPLICATION_GROUP] Loading skill: snowflake-create-replication-group")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-replication-group")]
)
logger.debug("[REPLICATION_GROUP] Skill loaded successfully")


ag_sf_manage_replication_group = LlmAgent(
