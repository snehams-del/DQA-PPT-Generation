...
logger.debug("[COMPUTE_POOL] Loading skill: snowflake-create-compute-pool")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-compute-pool")]
)
logger.debug("[COMPUTE_POOL] Skill loaded successfully")

ag_sf_manage_compute_pool = LlmAgent(
