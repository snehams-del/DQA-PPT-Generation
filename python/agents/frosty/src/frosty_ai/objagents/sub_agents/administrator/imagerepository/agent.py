...
logger.debug("[IMAGE_REPOSITORY] Loading skill: snowflake-create-image-repository")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-image-repository")]
)
logger.debug("[IMAGE_REPOSITORY] Skill loaded successfully")


ag_sf_manage_image_repository = LlmAgent(
