...
logger.debug("[CONNECTION] Loading skill: snowflake-create-connection")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-connection")]
)
logger.debug("[CONNECTION] Skill loaded successfully")


ag_sf_manage_connection = LlmAgent(
