...
logger.debug("[ALERT] Loading skill: snowflake-create-alert")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-alert")]
)
logger.debug("[ALERT] Skill loaded successfully")

ag_sf_manage_alerts = LlmAgent(
