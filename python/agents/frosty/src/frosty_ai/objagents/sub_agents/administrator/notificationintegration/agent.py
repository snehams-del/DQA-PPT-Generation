...
logger.debug("[NOTIFICATION_INTEGRATION] Loading skill: snowflake-create-notification-integration")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-notification-integration")]
)
logger.debug("[NOTIFICATION_INTEGRATION] Skill loaded successfully")

ag_sf_manage_notification_integration = LlmAgent(
