...
logger.debug("[ROLE] Loading skill: snowflake-create-role")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-role")]
)
logger.debug("[ROLE] Skill loaded successfully")

ag_sf_manage_role = LlmAgent(
