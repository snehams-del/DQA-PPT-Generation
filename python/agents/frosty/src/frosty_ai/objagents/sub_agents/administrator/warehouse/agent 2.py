...
logger.debug("[WAREHOUSE] Loading skill: snowflake-create-warehouse")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-warehouse")]
)
logger.debug("[WAREHOUSE] Skill loaded successfully")

ag_sf_manage_warehouse = LlmAgent(
