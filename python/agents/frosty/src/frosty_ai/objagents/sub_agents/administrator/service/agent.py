...
logger.debug("[SERVICE] Loading skill: snowflake-create-service")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-service")]
)
logger.debug("[SERVICE] Skill loaded successfully")


ag_sf_manage_service = LlmAgent(
