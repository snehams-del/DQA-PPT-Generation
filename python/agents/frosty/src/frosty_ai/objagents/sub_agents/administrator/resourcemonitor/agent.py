...
logger.debug("[RESOURCE_MONITOR] Loading skill: snowflake-create-resource-monitor")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-resource-monitor")]
)
logger.debug("[RESOURCE_MONITOR] Skill loaded successfully")

ag_sf_resource_monitor = LlmAgent(
