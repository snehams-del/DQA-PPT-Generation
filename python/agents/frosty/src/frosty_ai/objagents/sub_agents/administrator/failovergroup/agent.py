...
logger.debug("[FAILOVER_GROUP] Loading skill: snowflake-create-failover-group")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-failover-group")]
)
logger.debug("[FAILOVER_GROUP] Skill loaded successfully")


ag_sf_manage_failover_group = LlmAgent(
