...
logger.debug("[USER] Loading skill: snowflake-create-user")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-user")]
)
logger.debug("[USER] Skill loaded successfully")

ag_sf_manage_user = LlmAgent(
