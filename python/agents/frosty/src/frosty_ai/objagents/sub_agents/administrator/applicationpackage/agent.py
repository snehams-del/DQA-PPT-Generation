...
logger.debug("[APPLICATION_PACKAGE] Loading skill: snowflake-create-application-package")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-application-package")]
)
logger.debug("[APPLICATION_PACKAGE] Skill loaded successfully")

ag_sf_manage_application_package = LlmAgent(
