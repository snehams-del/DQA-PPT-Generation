...
logger.debug("[AUTHENTICATION_POLICY] Loading skill: snowflake-create-authentication-policy")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-authentication-policy")]
)
logger.debug("[AUTHENTICATION_POLICY] Skill loaded successfully")


ag_sf_manage_authentication_policy = LlmAgent(
