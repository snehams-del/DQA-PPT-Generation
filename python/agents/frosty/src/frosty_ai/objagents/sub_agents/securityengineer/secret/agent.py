...
logger.debug("[SECRET] Loading skill: snowflake-create-secret")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-secret")]
)
logger.debug("[SECRET] Skill loaded successfully")


ag_sf_manage_secret = LlmAgent(
