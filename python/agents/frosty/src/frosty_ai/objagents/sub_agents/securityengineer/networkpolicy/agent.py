...
logger.debug("[NETWORK_POLICY] Loading skill: snowflake-create-network-policy")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-network-policy")]
)
logger.debug("[NETWORK_POLICY] Skill loaded successfully")


ag_sf_manage_network_policy = LlmAgent(
