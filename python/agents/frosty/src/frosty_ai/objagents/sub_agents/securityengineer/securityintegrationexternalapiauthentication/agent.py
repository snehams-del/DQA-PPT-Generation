...
logger.debug("[SECURITY_INTEGRATION] Loading skill: snowflake-create-security-integration")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-security-integration")]
)
logger.debug("[SECURITY_INTEGRATION] Skill loaded successfully")


ag_sf_manage_security_integration_external_api_authentication = LlmAgent(
