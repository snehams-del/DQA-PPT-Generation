...
logger.debug("[NETWORK_RULE] Loading skill: snowflake-create-network-rule")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-network-rule")]
)
logger.debug("[NETWORK_RULE] Skill loaded successfully")


ag_sf_manage_network_rule = LlmAgent(
