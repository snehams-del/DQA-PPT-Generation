...
logger.debug("[AGGREGATION_POLICY] Loading skill: snowflake-create-aggregation-policy")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-aggregation-policy")]
)
logger.debug("[AGGREGATION_POLICY] Skill loaded successfully")


ag_sf_manage_aggregation_policy = LlmAgent(
