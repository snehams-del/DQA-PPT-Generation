...
logger.debug("[API_INTEGRATION] Loading skill: snowflake-create-api-integration")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-api-integration")]
)
logger.debug("[API_INTEGRATION] Skill loaded successfully")


ag_sf_manage_api_integration_amazon_api_gateway = LlmAgent(
