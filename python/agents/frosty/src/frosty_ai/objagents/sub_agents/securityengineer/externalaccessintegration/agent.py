...
logger.debug("[EXTERNAL_ACCESS_INTEGRATION] Loading skill: snowflake-create-external-access-integration")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-external-access-integration")]
)
logger.debug("[EXTERNAL_ACCESS_INTEGRATION] Skill loaded successfully")


ag_sf_manage_external_access_integration = LlmAgent(
