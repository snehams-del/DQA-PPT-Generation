...
logger.debug("[PACKAGES_POLICY] Loading skill: snowflake-create-packages-policy")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-packages-policy")]
)
logger.debug("[PACKAGES_POLICY] Skill loaded successfully")


ag_sf_manage_packages_policy = LlmAgent(
