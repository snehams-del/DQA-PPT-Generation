...
logger.debug("[PASSWORD_POLICY] Loading skill: snowflake-create-password-policy")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-password-policy")]
)
logger.debug("[PASSWORD_POLICY] Skill loaded successfully")


ag_sf_manage_password_policy = LlmAgent(
