...
logger.debug("[TASK] Loading skill: snowflake-create-task")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-task")]
)
logger.debug("[TASK] Skill loaded successfully")

ag_sf_manage_task = LlmAgent(
