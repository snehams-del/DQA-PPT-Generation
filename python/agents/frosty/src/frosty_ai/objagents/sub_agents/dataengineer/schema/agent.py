...
logger.debug("[SCHEMA] Loading skill: snowflake-create-schema")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-schema")]
)
logger.debug("[SCHEMA] Skill loaded successfully")

ag_sf_manage_schema = LlmAgent(
