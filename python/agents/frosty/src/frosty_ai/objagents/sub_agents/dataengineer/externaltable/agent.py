...
logger.debug("[EXTERNAL_TABLE] Loading skill: snowflake-create-external-table")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-external-table")]
)
logger.debug("[EXTERNAL_TABLE] Skill loaded successfully")


ag_sf_manage_external_table = LlmAgent(
