...
logger.debug("[USER_DEFINED_FUNCTION] Loading skill: snowflake-create-function")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-function")]
)
logger.debug("[USER_DEFINED_FUNCTION] Skill loaded successfully")


ag_sf_manage_user_defined_function = LlmAgent(
