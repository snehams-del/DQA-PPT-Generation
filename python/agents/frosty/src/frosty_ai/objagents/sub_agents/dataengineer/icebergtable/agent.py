...
logger.debug("[ICEBERG_TABLE] Loading skill: snowflake-create-iceberg-table")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-iceberg-table")]
)
logger.debug("[ICEBERG_TABLE] Skill loaded successfully")


ag_sf_manage_iceberg_table = LlmAgent(
