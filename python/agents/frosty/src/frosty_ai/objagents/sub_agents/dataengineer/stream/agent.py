...
logger.debug("[STREAM] Loading skill: snowflake-create-stream")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-stream")]
)
logger.debug("[STREAM] Skill loaded successfully")

ag_sf_manage_stream = LlmAgent(
