...
logger.debug("[TABLE] Loading skill: snowflake-create-table")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-table")]
)
logger.debug("[TABLE] Skill loaded successfully")

ag_sf_manage_table = LlmAgent(
