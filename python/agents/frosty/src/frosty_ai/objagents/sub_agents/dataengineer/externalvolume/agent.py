...
logger.debug("[EXTERNAL_VOLUME] Loading skill: snowflake-create-external-volume")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-external-volume")]
)
logger.debug("[EXTERNAL_VOLUME] Skill loaded successfully")

ag_sf_manage_external_volume = LlmAgent(
