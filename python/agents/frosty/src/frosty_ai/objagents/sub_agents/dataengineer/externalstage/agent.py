...
logger.debug("[EXTERNAL_STAGE] Loading skill: snowflake-create-external-stage")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-external-stage")]
)
logger.debug("[EXTERNAL_STAGE] Skill loaded successfully")

ag_sf_manage_external_stage = LlmAgent(
