...
logger.debug("[SEQUENCE] Loading skill: snowflake-create-sequence")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-sequence")]
)
logger.debug("[SEQUENCE] Skill loaded successfully")

ag_sf_manage_sequence = LlmAgent(
