...
logger.debug("[VIEW] Loading skill: snowflake-create-view")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-view")]
)
logger.debug("[VIEW] Skill loaded successfully")

ag_sf_manage_view = LlmAgent(
