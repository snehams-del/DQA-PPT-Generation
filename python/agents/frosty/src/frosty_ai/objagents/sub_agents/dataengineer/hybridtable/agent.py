...
logger.debug("[HYBRID_TABLE] Loading skill: snowflake-create-hybrid-table")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-hybrid-table")]
)
logger.debug("[HYBRID_TABLE] Skill loaded successfully")


ag_sf_manage_hybrid_table = LlmAgent(
