...
logger.debug("[DYNAMIC_TABLE] Loading skill: snowflake-create-dynamic-table")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-dynamic-table")]
)
logger.debug("[DYNAMIC_TABLE] Skill loaded successfully")


ag_sf_manage_dynamic_table = LlmAgent(
