...
logger.debug("[EXTERNAL_FUNCTION] Loading skill: snowflake-create-external-function")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-external-function")]
)
logger.debug("[EXTERNAL_FUNCTION] Skill loaded successfully")


ag_sf_manage_external_function = LlmAgent(
