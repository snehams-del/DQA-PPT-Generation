...
logger.debug("[NOTEBOOK] Loading skill: snowflake-create-notebook")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-notebook")]
)
logger.debug("[NOTEBOOK] Skill loaded successfully")

ag_sf_manage_notebook = LlmAgent(
