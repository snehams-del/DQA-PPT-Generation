...
logger.debug("[EVENT_TABLE] Loading skill: snowflake-create-event-table")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-event-table")]
)
logger.debug("[EVENT_TABLE] Skill loaded successfully")


ag_sf_manage_event_table = LlmAgent(
