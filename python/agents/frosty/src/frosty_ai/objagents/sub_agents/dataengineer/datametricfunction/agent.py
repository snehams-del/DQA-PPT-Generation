...
logger.debug("[DATA_METRIC_FUNCTION] Loading skill: snowflake-create-data-metric-function")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-data-metric-function")]
)
logger.debug("[DATA_METRIC_FUNCTION] Skill loaded successfully")


ag_sf_manage_data_metric_function = LlmAgent(
