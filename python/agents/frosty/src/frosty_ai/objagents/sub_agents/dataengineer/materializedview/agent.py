...
logger.debug("[MATERIALIZED VIEW] Loading skill: snowflake-create-materialized-view")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-materialized-view")]
)
logger.debug("[MATERIALIZED VIEW] Skill loaded successfully")

ag_sf_manage_materialized_view = LlmAgent(
