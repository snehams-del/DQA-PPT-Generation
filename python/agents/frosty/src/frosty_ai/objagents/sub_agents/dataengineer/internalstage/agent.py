...
logger.debug("[INTERNAL_STAGE] Loading skill: snowflake-create-internal-stage")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-internal-stage")]
)
logger.debug("[INTERNAL_STAGE] Skill loaded successfully")

ag_sf_manage_internal_stage = LlmAgent(
