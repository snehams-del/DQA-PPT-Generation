...
logger.debug("[SEMANTIC_VIEW] Loading skill: snowflake-create-semantic-view")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-semantic-view")]
)
logger.debug("[SEMANTIC_VIEW] Skill loaded successfully")


ag_sf_manage_semantic_view = LlmAgent(
