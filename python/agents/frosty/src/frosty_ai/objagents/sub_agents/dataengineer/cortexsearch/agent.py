...
logger.debug("[CORTEX_SEARCH] Loading skill: snowflake-create-cortex-search")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-cortex-search")]
)
logger.debug("[CORTEX_SEARCH] Skill loaded successfully")


ag_sf_manage_cortex_search = LlmAgent(
