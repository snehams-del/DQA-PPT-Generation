...
logger.debug("[PROJECTION POLICY] Loading skill: snowflake-create-projection-policy")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-projection-policy")]
)
logger.debug("[PROJECTION POLICY] Skill loaded successfully")


ag_sf_manage_projection_policy = LlmAgent(
