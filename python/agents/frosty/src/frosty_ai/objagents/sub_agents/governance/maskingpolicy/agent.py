...
logger.debug("[MASKING POLICY] Loading skill: snowflake-create-masking-policy")
_skill_toolset = SkillToolset(
    skills=[load_skill_from_dir(_skills_dir / "snowflake-create-masking-policy")]
)
logger.debug("[MASKING POLICY] Skill loaded successfully")


ag_sf_manage_masking_policy = LlmAgent(
