...
class TestBibparse(unittest.TestCase):
    ...
    def test_mr_dna(self):
        """Test inspired by a request to activate Mr. DNA."""
        # In this file, 'mr' is an alias for a macro reference parser.
        mr = bp.macro_ref
        # Let's see if Mr. DNA is a valid macro reference.
        res = mr.parseString("dna")
        self.assertEqual("dna", res[0].name)
        # And as part of a field value...
        fv = bp.field_value
        res = fv.parseString("dna # {is the code of life}")
        self.assertEqual([Macro("dna"), "is the code of life"], res.asList())
